...
type UserConfig struct {
	...
	MaxToolRounds int    `gorm:"default:0;comment:连续调用工具轮数上限（0=无限制，范围1-50；未配置默认15）" json:"max_tool_rounds"`
	...
	// OTACO 总迭代轮数上限（0=无限制，范围1-50；未配置默认10）
	MaxOTACOIterations int `gorm:"default:0;comment:OTACO总迭代轮数上限（0=无限制，范围1-50；未配置默认10）" json:"max_otaco_iterations"`
